...
// Request Google Drive and Google Sheets scopes as requested
...
// Track scopes to see if we have them
  ...
  return onAuthStateChanged(auth, async (user: User | null) => {
    if (user) {
      if (cachedAccessToken) {
        ...
        // we might need to ask them to sign in again to get the fresh token
        // since Firebase doesn't persist the Google OAuth Access Token automatically.
